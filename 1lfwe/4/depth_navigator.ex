defmodule DepthNavigator do
  ...
  #Igual que en el otro pero en go_through mando 0 que es la current_depth (estoy en el padre)
  def navigate(dir) do
    expanded_dir = Path.expand(dir)
    go_through([expanded_dir], 0)
  end

  #Hace lo mismo que antes pero suma una a la current_depth
  ...
  #lo mismo pero corta ademas cuando superamos la max_depth
