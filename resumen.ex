...
#PM desestructurar y testear-------------------------------------------Access

austin = %{city: "Austin", state: "Tx"}
%{city: "Austin", state: "Tx"}

defmodule Place do
  def city(%{city: city}), do: city #PM Desestructura -> nos quedamos con la city
  def texas?(%{state: "Tx"}), do: true #PM como test -> si es texas da true
